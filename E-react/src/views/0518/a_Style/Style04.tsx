...
// : ThemeProvider를 사용하여 원하고자 하는 
//   styled-components의 맥락에 전역 테마를 설정
...
const Button = styled.button<ButtonProps>`
  ...
  &:hover {
    background-color: ${props => {
      const color = props.theme.colors[props.color] || '#000'; // 배경 색상 설정
...
export default function Style04() {
  ...
  const dynamicTheme = {
    colors: {
      backgrounds :themeMode === 'light' ? 'white' : '#333',
