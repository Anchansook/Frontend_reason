...
export default function Component01() {
  ...
  // - return 키워드와 동일한 줄에서 컴포넌트 호출이 이루어지지 않거나 
  //   여러 개의 컴포넌트를 호출 할 경우 반드시 () 소괄호로 감싸서 사용
  return (
    <div>
      {/*  
        return에서 태그 사용 시
      ...
      */}
      {/* p태그, img태그 - HTML 태그 */}
      <p>강아지 이미지 컴포넌트 사용</p>
      <img src="https://cdn.pixabay.com/photo/2022/07/19/10/35/puppies-7331739_640.jpg" alt="HTML img 강아지" width={100} />
