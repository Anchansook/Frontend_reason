...
//! 쿼리 파라미터
// : 웹 애플리케이션에서 사용자 입력, 페이지 상태, 
//   기타 (부수적인)데이터를 URL을 통해 전달하는 방법
// : URL의 ? 뒤에 위치
//   , key=value 의 형태로 다수가 & 기호로 연결될 수 있음

// >> 리액트에서는 react-router-dom 라이브러리의 useSearchParams 훅을 사용하여 쿼리 파라미터를 관리

//? 쿼리 파라미터의 장점
// 1. 상태 유지
// : 사용자가 애플리케이션에서 데이터를 입력하고 페이지를 새로고침할 때
//   , URL에 포함된 쿼리 파라미터에 데이터를 저장하여 데이터 값이 유지
// 2. 복잡한 데이터 관리
