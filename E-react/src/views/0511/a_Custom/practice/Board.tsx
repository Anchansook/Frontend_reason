...
const usePosts = () => {  
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setPosts([
        ...
        { id: 1, author: '이용주', date: '2024-05-11', title: '첫 게시물1', content: '리액트 커스텀 훅1'},
        { id: 2, author: '정재형', date: '2024-05-11', title: '첫 게시물2', content: '리액트 커스텀 훅2'},
        { id: 3, author: '김민수', date: '2024-05-11', title: '첫 게시물3', content: '리액트 커스텀 훅3'},
        { id: 4, author: '송혜교', date: '2024-05-11', title: '첫 게시물4', content: '리액트 커스텀 훅4'},
        { id: 5, author: '김유정', date: '2024-05-11', title: '첫 게시물5', content: '리액트 커스텀 훅5'}
      ]);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  // 게시물 삭제 로직
  const deletePost = useCallback((id :number) => { // 인자를 안 넣어서 id 안 읽혔음!!!
...
export default function Board() {
  ...
  const handleAddPost = (e :React.FormEvent<HTMLFormElement>) => {
    ...
    const newPosts :PostType = {
      ...
      // >> 'YYYY-MM-DDTHH:mm:ss:sssZ' - 미만 자리까지(10이면 9자리까지)
